                ...
                >
                    ...
                    >
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} method="post" className="space-y-4">
                            ...
                            <button
                                className={`${signup.isPending? "bg-white p-2 border flex justify-center": "bg-gradient-to-r hover:scale-105 hover:from-purple-500 hover:to-blue-500 transition duration-300 ease-in-out dark:text-gray-300 from-blue-500 to-purple-500 shadow-lg mt-6 p-2" }  cursor-pointer text-white rounded-lg w-full  `}
                                type="submit"
